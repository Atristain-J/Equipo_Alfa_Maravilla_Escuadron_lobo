...
class Ventana(QMainWindow):
    def __init__(self):
        ...
        self.etiqueta_indicador_encendido = QLabel ()
        self.etiqueta_indicador_encendido.setFixedSize(30, 30)
        self.etiqueta_indicador_apagado = QLabel ()
        self.etiqueta_indicador_apagado.setFixedSize(30, 30)
        ...
        layout_superior.addWidget(self.etiqueta_indicador_encendido, 0, 0)
        layout_superior.addWidget(self.etiqueta_indicador_apagado, 1, 0)
        ...
        widget = QWidget()
        widget.setLayout(layout_vertical1)#aqui se mete la  principal
        self.setCentralWidget(widget)

        #condiciones iniciales
        self.cambiar_estado_boton(self.etiqueta_indicador_encendido, False)
        self.cambiar_estado_boton(self.etiqueta_indicador_apagado, False)
        ...
        def cambiar_boton_encender(self, valor):
            self.cambiar_estado_boton(self.etiqueta_indicador_encendido, valor)
        
        def cambiar_boton_apagar(self, valor):
            self.cambiar_estado_boton(self.etiqueta_indicador_apagado, valor)
        ...
        def cambiar_estado_boton(self, boton, estado):
            ...
            boton.setStyleSheet(f"""Border: 1px solid {color};
                border-radius: 15px;
